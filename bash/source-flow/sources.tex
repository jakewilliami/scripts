...
\begin{document}
	\begin{tikzpicture}[node distance=8em]	
		...
		\scriptsize Sources \texttt{scripts/bash/dependencies/package-man.sh}.  Checks to see if \texttt{jq} is installed.  If not, install it.  Sources \texttt{scripts/bash/colours/json-colour-parser.sh}.};%sources dependencies/package-man.sh; sources colours/json-colour-parser.sh
		...
		\node(n1-4)[firstlayer, right=of n1-3, xshift=-6em, yshift=-1em]{\texttt{scripts/bash/dependencies/aur.sh}\\
		...
		\node(n1-7)[firstlayer, right=of n1-6, yshift=-8em, xshift=-9em]{\texttt{scripts/bash/help/option-errors.sh}\\
		...
		\node(n1-2-2)[secondlayer, right=of n1-2-1, yshift=-7em]{\texttt{scripts/bash/colours.json-colour-parser.sh}\\
