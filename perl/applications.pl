...
my $filesysProf = "${home}/projects/scripts/perl/temp.d/system_profile.txt";
...
my $filecasks = "${home}/projects/scripts/perl/temp.d/casks.txt";
...
my $filedataApps = "${home}/projects/scripts/perl/temp.d/dataApps.txt";
...
open (APPS1, "<${home}/projects/scripts/perl/temp.d/dataApps.txt") or die $!;
    my %file_1_hash;
    my $line;
    my $line_counter = 0;
...
close (APPS1);
    ...
    open(APPS2, "<${home}/projects/scripts/perl/temp.d/casks.txt") or die $!;
    $line_counter = 0;
    while ($line=<APPS2>){
        $line_counter++;
    #  chomp ($line);
