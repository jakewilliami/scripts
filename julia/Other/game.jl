...
#=
# (down, across)
courgette goes at position (4, 6)
carrot goes at position (3, 3)
potato goes at position (3, 5)
squash2 goes at position (3, 2)
potato2 goes at position (6, 2)
squash goes at position (4, 4)
=#
...
#=
# (down, across)
squash2 goes at position CartesianIndex(1, 1)
potato2 goes at position CartesianIndex(2, 4)
squash goes at position CartesianIndex(1, 6)
potato3 goes at position CartesianIndex(3, 5)
potato goes at position CartesianIndex(4, 1)
courgette goes at position CartesianIndex(4, 4)
carrot goes at position CartesianIndex(4, 6)
=#
